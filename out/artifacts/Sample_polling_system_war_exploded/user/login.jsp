...
<section>
    <div class="container">
        <div class="centered form">
            ...
            <form role="form" class="live_form form" id="login_form" method="post" action="user.login">
                ...
                <div class="form-group">
                    <label for="pass">Password <a href="forgot.jsp" class="pull-right" id="forgot-password">(Forgot Password)</a></label>
